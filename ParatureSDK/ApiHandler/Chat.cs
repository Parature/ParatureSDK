...
namespace ParatureSDK.ApiHandler
{
    ...
    public class Chat : FirstLevelApiGetMethods<ParaObjects.Chat, ChatQuery>
    {
        ...
        /// </param>
        [Obsolete("To be removed in favor of ParaService.GetDetails and ParaService.GetDetailsWithHistory in next major revision.", false)]
        ...
        [Obsolete("To be removed in favor of ParaService.GetChatTranscript in next major revision.", false)]
