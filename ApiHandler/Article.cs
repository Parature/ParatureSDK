    ...
    public static class Article
    {
        ...
        public static ParaObjects.Article Schema(ParaCredentials pc)
        {
            ...
            if (ar.HasException == false)
            {
                ...
                Article = ParaEntityParser.EntityFill<ParaObjects.Article>(purgedSchema);
            }
        ...
        private static ParaEntityList<ParaObjects.Article> FillList(ParaCredentials ParaCredentials, ArticleQuery Query, ParaEnums.RequestDepth RequestDepth)
        {
            ...
            {
                OptimizationResult rslt = ApiUtils.OptimizeObjectPageSize(ArticlesList, Query, ParaCredentials, ParaEnums.ParatureModule.Article);
                ar = rslt.apiResponse;
