...
{
    class ParaEntityParser
    {
        public static T EntityFill<T>(XDocument xml) where T: ParaObjects.ParaEntity
        {
             ...
             */
            var wrapperElements = xml.Descendants().Where(node => node.HasElements);
            foreach (var wrapper in wrapperElements)
            {
                ...
                switch (wrapperTagName)
                {
                    ...
                    case "Default_Customer_Role":
                        ...
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as Sla;
                        break;
                    case "Modified_By": //Articles and Accounts both have this one
                        ...
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as Csr;
                        break;
                    case "Owned_By":
                        nodeSerializer = new XmlSerializer(typeof(Csr));
                        field.DataType = ParaEnums.FieldDataType.EntityReference;
                    ...
                    case "Account":
                        ...
                        field.DataType = ParaEnums.FieldDataType.EntityReference;
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as Account;
                        break;
                    case "Customer_Role":
                        nodeSerializer = new XmlSerializer(typeof(Sla));
                        field.DataType = ParaEnums.FieldDataType.Sla;
                    ...
                    case "Status": //Asset, customer, chat
                        ...
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as Status;
                        break;
                    //customer or account
                    case "Sla":
                        nodeSerializer = new XmlSerializer(typeof(Sla));
                    ...
                    case "Eula":
                        ...
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as Eula;
                        break;
                    ...
                    case "Folder":  //Products too
                        ...
                        if (folderWrapper != null)
                        {
                            ...
                            switch (folderName)
                            {
                                ...
                                case "ProductFolder":
                                    ...
                                    field.DataType = ParaEnums.FieldDataType.Folder;
                                    field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as List<ProductFolder>;
                                    break;
                                default:
                                    break;
                            }
                        ...
                        field.DataType = ParaEnums.FieldDataType.Folder;
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as DownloadFolder;
                        break;
                    //Articles
                    ...
                    case "Customer_Owner":
                        ...
                        field.DataType = ParaEnums.FieldDataType.EntityReference;
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as Customer;
                        break;
                    //Asset
                    case "Product":
                        nodeSerializer = new XmlSerializer(typeof(Product));
                        field.DataType = ParaEnums.FieldDataType.EntityReference;
                        field.Value = nodeSerializer.Deserialize(wrapper.CreateReader()) as Product;
                        break;
                    //chat
                    case "Initial_Csr":
                        nodeSerializer = new XmlSerializer(typeof(Product));
