...
namespace ParatureAPI.XmlToObjectParser
{
    ...
    internal partial class DownloadParser
    {
        ...
        /// </summary>
        static internal DownloadsList DownloadsFillList(XmlDocument xmlresp, Boolean MinimalisticLoad, int requestdepth, ParaCredentials ParaCredentials)
        {
        ...
        internal partial class DownloadFolderParser
        {
            ...
            /// </summary>
            static internal DownloadFoldersList DownloadFoldersFillList(XmlDocument xmlresp, int requestdepth, ParaCredentials ParaCredentials)
            {
