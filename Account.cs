    ...
    public class Account
    {
        ...
        private static ParaObjects.AccountsList AccountsFillList(ParaCredentials ParaCredentials, ModuleQuery.AccountQuery Query, ParaEnums.RequestDepth RequestDepth)
        {
            ...
            if (Query.IncludeAllCustomFields == true)
            {
                ...
                objschem = ParatureAPI.Account.AccountSchema(ParaCredentials);
            ...
            {
                ParaObjects.OptimizationResult rslt = ApiHandler.OptimizeObjectPageSize(AccountsList, Query, ParaCredentials, requestdepth, ParaEnums.ParatureModule.Account);
                ar = rslt.apiResponse;
